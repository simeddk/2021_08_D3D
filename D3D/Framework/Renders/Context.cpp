...
void Context::Update()
{
	ImGui::SliderFloat("Camera Position.x", &position.x, 0, 128);
	ImGui::SliderFloat("Camera Position.y", &position.y, -20, 20);
	ImGui::SliderFloat("Camera Position.z", &position.z, -128, 128);
