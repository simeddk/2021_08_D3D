...
void MrtDemo::Initialize()
{
	...
	postProcess = new PostProcess(L"35_Mrt.fxo");
...
void MrtDemo::Render()
{
	static UINT tarngetIndex;
	ImGui::InputInt("TargetIndex", (int*)&tarngetIndex);
	tarngetIndex %= 3;

	postProcess->SRV(mrt[tarngetIndex]->SRV());
	postProcess->Pass(0);
