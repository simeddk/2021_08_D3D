...
bool Collider::SeparatingPlane(Vector3 & distance, Vector3 & direction, Bounding & box1, Bounding & box2)
{
...
bool Collider::Collision(Bounding & box1, Bounding & box2)
{
	...
	if (SeparatingPlane(distance, box1.AxisX, box1, box2)) return false;
	if (SeparatingPlane(distance, box1.AxisY, box1, box2)) return false;
	if (SeparatingPlane(distance, box1.AxisZ, box1, box2)) return false;

	if (SeparatingPlane(distance, box2.AxisX, box1, box2)) return false;
	if (SeparatingPlane(distance, box2.AxisY, box1, box2)) return false;
	if (SeparatingPlane(distance, box2.AxisZ, box1, box2)) return false;

	if (SeparatingPlane(distance, Cross(box1.AxisX, box2.AxisX), box1, box2)) return false;
	if (SeparatingPlane(distance, Cross(box1.AxisX, box2.AxisY), box1, box2)) return false;
	if (SeparatingPlane(distance, Cross(box1.AxisX, box2.AxisZ), box1, box2)) return false;

	if (SeparatingPlane(distance, Cross(box1.AxisY, box2.AxisX), box1, box2)) return false;
	if (SeparatingPlane(distance, Cross(box1.AxisY, box2.AxisY), box1, box2)) return false;
	if (SeparatingPlane(distance, Cross(box1.AxisY, box2.AxisZ), box1, box2)) return false;

	if (SeparatingPlane(distance, Cross(box1.AxisZ, box2.AxisX), box1, box2)) return false;
	if (SeparatingPlane(distance, Cross(box1.AxisZ, box2.AxisY), box1, box2)) return false;
	if (SeparatingPlane(distance, Cross(box1.AxisZ, box2.AxisZ), box1, box2)) return false;
