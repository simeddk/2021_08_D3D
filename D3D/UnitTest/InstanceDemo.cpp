...
void InstanceDemo::Initialize()
{
	...
	shader = new Shader(L"23_Instance.fxo");
	...
	instanceWorldBuffer = new VertexBuffer(worlds, MAX_DRAW_COUNT, sizeof(Matrix), 1);
	instanceColorBuffer = new VertexBuffer(colors, MAX_DRAW_COUNT, sizeof(Color), 2);
}
...
void InstanceDemo::Render()
{
	...
	shader->DrawIndexedInstanced(0, 2, indices.size(), MAX_DRAW_COUNT);
