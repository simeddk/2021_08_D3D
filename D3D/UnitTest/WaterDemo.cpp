...
void WaterDemo::Initialize()
{
	...
	shader = new Shader(L"52_Water.fxo");
	...
	water = new Water
	(
		Water::InitializeDesc{ shader, 125, L"Terrain/Gray256.png", 0, 0 }
	);
...
void WaterDemo::Update()
{
	...
	//WaterMap
	{
		if (ImGui::Button("WaterMap"))
		{
			...
			Path::OpenFileDialog(L"", Path::ImageFilter, filePath, water->DeleChangeWaterMap);
		}
	}
